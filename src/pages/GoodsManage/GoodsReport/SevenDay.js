...
export default class Index extends React.Component {
  ...
  componentDidMount() {
    storeReportFromTime(3).then(res => {
      this.setState({
        result: res,
      });
    });
        ...
        <View style={styles.containerWrap}>
          ...
          <View style={styles.headerDataWrap}>
            <View style={styles.headerDataItem}>
              <Text style={styles.headerDataText1}>近七日淘宝佣金(元)</Text>
          ...
          <View style={styles.item2}>
            ...
            >
              <View style={styles.headerDataItem}>
                <Text style={styles.headerDataText1}>近七日付款金额(元)</Text>
          ...
          <View style={styles.item2}>
            ...
            >
              <View style={styles.headerDataItem}>
                <Text style={styles.headerDataText1}>近七日新增客户数</Text>
