...
import { waitTeams, waitSales, waitAmount, waitStore, waitOrder } from '../../services/api';
import EmptyState from '../../components/EmptyState';
import FitRule from '../../components/FitRule';
import FitRuleBtn from '../../components/FitRuleBtn';
import LoadingText from '../../components/LoadingText';

export default class WaitBack extends Component {
  ...
  async fetchListData(currentPage, type) {
    ...
    switch (type) {
      case 0:
        res = await waitSales(currentPage);
        break;
      case 1:
        res = await waitTeams(currentPage);
        break;
      case 2:
        res = await waitStore(currentPage);
        break;
      default:
        res = await waitOrder(currentPage);
        break;
    }
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.titleWrap}>
          ...
          <Text style={styles.title}>审核中(元)</Text>
